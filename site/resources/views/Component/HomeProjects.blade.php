            ...
            @foreach($projectData as $project)
                ...
                <div class="item m-1 card">
                    <div class="text-center">
                        <img class="w-100" src="{{ asset('images/project.jpg') }}" alt="Card image cap">
                        <h5 class="service-card-title mt-4">{{ $project->project_name }}</h5>
                        <h6 class="service-card-subTitle p-0 m-0">{{ $project->project_name }} </h6>
                        <a class="normal-btn-outline mt-2 mb-4 btn" href="{{ $project->project_link }}">Details</a>
