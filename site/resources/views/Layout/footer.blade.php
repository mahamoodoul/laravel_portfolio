    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> Shukrabad,Dhanmondi,Dhaka </p>
                <p class="footer-text"><i class="fas fa-phone"></i> 01173521823 </p>
                <p class="footer-text"><i class="fas fa-envelope"></i>mahamodul.shakil11@gmail.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">All Right Reserved By Shakil- 2020-2021</p>
</div>
